...
def main():
    st.title("Resume OCR")
    st.write("Upload a resume PDF file.")
    ...
    if uploaded_file and client:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            if st.button("Analyze Resume"):
                with st.spinner("Processing..."):
                    result = process_resume_pdf(temp_pdf_path, temp_dir, client, image_format="jpg")
        ...
        st.info("Please upload a resume PDF file to begin.")
